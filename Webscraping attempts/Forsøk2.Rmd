...
for(i in 1:length(statistikk)){
  ...
  statistikk_navn <- gsub("(.*?)\\/statistikk\\/", "", liste) # Fjerner første del av url'en frem til og med /statistikk/ for å lage passende filnavn
  # print(statistikk_navn) - test
  for (j in 1:length(liste)){
    download.file(liste[j],
                  destfile = str_c("./Data/statistikk/", statistikk_navn[j], ".html"))
...
Bare 93 statistikker, for få men vet ikke hvorfor?
